...
def _safe_logfire_span(name: str, **kwargs):
...
def _safe_logfire_info(message: str, **kwargs):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="Enable Logfire observability (default: enabled)"
    )
    parser.add_argument(
        "--disable-logfire",
        action="store_true",
        help="Disable Logfire observability"
    )
