...
@pytest.mark.asyncio
async def test_thought_produces_expected_reasoning_and_action_call(setup_simple_react_agent: Callable) -> None:
...
@pytest.mark.asyncio
async def test_thought_produces_expected_reasoning_and_direct_answer(setup_simple_react_agent: Callable) -> None:
...
@pytest.mark.asyncio
async def test_thought_produces_expected_reasoning_and_no_answer(setup_simple_react_agent: Callable) -> None:
...
@pytest.mark.asyncio
async def test_handles_empty_response_properly(setup_simple_react_agent: Callable) -> None:
...
@pytest.mark.asyncio
async def test_handles_untagged_output(setup_simple_react_agent: Callable) -> None:
    """Test handling of untagged/malformed LLM output."""
    agent = setup_simple_react_agent(
        chain=["This is an unexpected response format that does not follow the required structure."], max_reasoning=2
    )
...
@pytest.mark.asyncio
async def test_handles_unrecognized_tool_call(setup_simple_react_agent: Callable) -> None:
...
@pytest.mark.asyncio
async def test_handles_thought_without_answer(setup_simple_react_agent: Callable) -> None:
...
@pytest.mark.asyncio
async def test_max_reasoning_with_parser_errors(setup_simple_react_agent: Callable) -> None:
...
@pytest.mark.asyncio
async def test_multi_step_reasoning_chain(setup_simple_react_agent: Callable) -> None:
